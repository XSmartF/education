...
export const deckApi = {
  ...
  update: (id: string, payload: UpdateDeckRequest) => api.put<DeckDetail>(`/decks/${id}`, payload),
  addCard: (id: string, payload: CreateDeckCardRequest) =>
    api.post<DeckCard>(`/decks/${id}/cards`, payload),
