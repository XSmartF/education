...
public sealed record CreateTodoRequest([property: Required] [property: MaxLength(200)] string Title);

public sealed record UpdateTodoRequest([property: Required] [property: MaxLength(200)] string Title, bool IsDone);
