...
{
    /// <inheritdoc />
    public partial class LearningEconomyCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackText = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeckPurchases_Decks_DeckId",
                        column: x => x.DeckId,
                        principalTable: "Decks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeckPurchases_DeckId_BuyerId",
                table: "DeckPurchases",
                columns: new[] { "DeckId", "BuyerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReputationProfiles_UserId",
